...
# 五环
turtle.penup()
turtle.goto(-20, -170)#-5
turtle.pendown()
turtle.pencolor("blue")
turtle.circle(6)
turtle.penup()
turtle.goto(-5, -170)#10

turtle.pendown()
turtle.pencolor("black")
turtle.circle(6)
turtle.penup()
turtle.goto(10, -170)#25
turtle.pendown()
turtle.pencolor("brown")

turtle.circle(6)
turtle.penup()
turtle.goto(-13, -175)#2
turtle.pendown()
turtle.pencolor("lightgoldenrod")
turtle.circle(6)
turtle.penup()

turtle.goto(1, -175)#16
turtle.pendown()
turtle.pencolor("green")
turtle.circle(6)
turtle.penup()
turtle.pencolor("black")
turtle.goto(-36, -160)#-11
turtle.write("BEIJING 2022", font=('Arial', 10, 'bold italic'))
turtle.hideturtle()

#签名
# turtle.goto(-20,-140)
# turtle.write("♡周飞♡", font=('Arial', 12, 'bold italic'))
# turtle.hideturtle()
